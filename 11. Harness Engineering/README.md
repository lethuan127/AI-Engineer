...
Read 11.1 → 11.8 in order. 11.19 is a direct deepening of 11.5 — read it right after, or whenever you are building permission checks of your own. 11.14, 11.15, 11.17, and 11.18 are cross-cutting theses (11.18 applies 11.14's argument to the toolset specifically, and assumes 11.7) — read them after 11.8 and 11.11 (11.15 builds directly on 11.14; 11.17 assumes 11.4, 11.5, and 11.6). 11.9 and 11.10 are reference material. 11.11 is for when the harness becomes a team asset rather than a personal config. 11.12, 11.13, and 11.16 are the "domain transfer" notes — same discipline, different corpus.
