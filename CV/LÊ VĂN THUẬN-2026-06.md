...
- **Observability & Quality**: OpenTelemetry · Elastic APM · Sentry · LLM/agent tracing & evals · Jest · unit / e2e testing · Semgrep (SAST)
...
- Led a **domain-driven modular restructuring** of the backend across 4+ repositories, cutting complexity and enabling **40% faster feature development**
- Reduced LLM operational costs **60%** via data preprocessing and batch API handling; designed a recommendation engine using hierarchical data (ltree), vector similarity, and weighted scoring
- Optimized database performance through strategic indexing and query tuning, achieving **90% reduction** in API response times
- Implemented end-to-end tracing (Sentry + OpenTelemetry/Grafana), cutting issue-detection time **90%**; built a unified web-crawler service for cross-platform data consistency
...
- Architected event-driven microservices enabling seamless partner scaling; reduced order-processing time **70%** through workflow automation; integrated Shopee, Lazada, and Tiki
- Designed **Kafka/Flink ETL pipelines** for the Warehouse Management System (SWM), cutting report query time **90%** and lifting inventory accuracy to **99.5%**
